...
class _CreateTaskSheetState extends State<CreateTaskSheet> {
  ...
  // ✅ Time Estimation Field - ครบถ้วน
  Widget _buildTimeEstimationField() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    onChanged: (_) => controller.calculateEstimatedTime(),
                  ),
                ],
              ),
            ),
              ...
              child: Column(
                children: [
                  ...
                  DropdownButtonFormField<int>(
                    ...
                    onChanged: (minutes) {
                      if (minutes != null) {
                        controller.setQuickTime(minutes);
                      }
                    },
                  ),
                ],
        ...
        // Show estimated time summary
        if (controller.estimatedDuration != null) ...[
          const SizedBox(height: 12),
          Container(
            width: double.infinity,
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 8),
                Text(
                  'Estimated time: ${controller.estimatedTimeText}',
                  style: const TextStyle(
                    fontSize: 14,
                    color: Color(0xFF8B5CF6),
        ...
        Wrap(
          spacing: 8,
          children: [
            _buildQuickTimeButton('Quick Task', () => controller.setQuickTime(30)),
            _buildQuickTimeButton('Half Day', () => controller.setQuickTime(240)),
            _buildQuickTimeButton('Full Day', () => controller.setQuickTime(480)),
          ],
        ),
      ],
    );
  ...
  // ✅ Initial Progress Slider - ครบถ้วน
  ...
  String _getProgressMessage() {
    final progress = controller.initialProgress;
    if (progress == 1.0) return 'Task will be marked as completed immediately';
    if (progress >= 0.7) return 'Task is almost done and will be marked in progress';
    if (progress >= 0.3) return 'Task will start with significant progress';
